...
$usuario = "garian"; //El usuario que acabamos de crear en la base de datos
$contrasenha = "garian65"; //La contraseña del usuario que utilizaremos
$BD = "Gari_Book"; //El nombre de la base de datos
